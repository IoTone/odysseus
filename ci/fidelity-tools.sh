...
names='bash python web_search web_fetch read_file grep glob ls write_file edit_file manage_notes manage_tasks manage_endpoints manage_mcp manage_webhooks manage_tokens manage_documents manage_settings manage_skills manage_calendar'
